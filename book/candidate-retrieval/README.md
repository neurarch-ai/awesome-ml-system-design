...
[semantic-search](https://github.com/neurarch-ai/awesome-llm-system-design/tree/main/book/semantic-search/) is the same two-tower and ANN machinery serving text search, with quantization and hybrid retrieval.
