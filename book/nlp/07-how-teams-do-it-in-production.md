...
| Meta hate speech | classification (toxicity) | RIO plus Linformer plus XLM-R, multimodal WPIE | many languages | proactive online sampling via RIO | near real-time inline firehose | proactive detection rate, false block rate | adversarial evasion; multimodal cases benign alone but hateful combined |
