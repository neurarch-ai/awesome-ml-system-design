...
- **Cheng et al.** [Wide and Deep Learning](https://arxiv.org/abs/1606.07792): memorization plus generalization, the Google Play CTR model, jointly training a wide linear model of cross-product feature transformations alongside a deep feed-forward network over embeddings in a single loss. *(model)*
...
- **LinkedIn** [Lessons from a deep-learning ads CTR prediction model](https://www.linkedin.com/blog/engineering/machine-learning/challenges-and-practical-lessons-from-building-a-deep-learning-b): replacing GLMix with a three-tower DNN; calibration under exposure bias (the model only sees clicks on ads it already chose to show). *(deployment)*
