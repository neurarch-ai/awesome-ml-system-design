...
| Uber D3 | column-level data drift | Spark column stats vs Prophet dynamic bands | PagerDuty on breach | detect + alert; manual response | seasonal data; 300+ datasets yielding 100,000+ column-level monitors; \$0.01 per dataset | stops at detect and page; Prophet baselines need tuning |
...
- **Uber** [D3: an automated system to detect data drifts](https://www.uber.com/blog/d3-an-automated-system-to-detect-data-drifts/): Prophet-based dynamic thresholds across 300+ datasets yielding 100,000+ column-level monitors. *(deployment)*
- **Uber** [Model Excellence Scores: enhancing ML quality at scale](https://www.uber.com/en-GB/blog/enhancing-the-quality-of-machine-learning-systems-at-scale/): SLA-style scoring across lifecycle phases to standardize a quality bar across models and teams. *(eval bar)*
